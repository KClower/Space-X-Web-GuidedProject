...
//import { missionsData } from "./components/MissionsList.test";
...
const button = getByRole('button', {name: /get data/i});
    ...
    //  Comonent waits for API
    //     - then renders data that is returned
    // change the test callBack function to an async/await test
